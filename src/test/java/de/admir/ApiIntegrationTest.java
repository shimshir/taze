...
import de.admir.repository.ProductRepository;
...
public class ApiIntegrationTest {
    ...
    public void testSearchOrderBySessionIdAndStatusId() {
        ...
        ResponseEntity<String> findNonExistingOrderRes = restTemplate.getForEntity(API_REST_BASE_PATH +
        ...
        ResponseEntity<String> findExistingOrderRes = restTemplate.getForEntity(API_REST_BASE_PATH +
    ...
    public void testAddOrderEntryWithProductToOrder() {
        ...
        JSONObject orderEntryReqJson = new JSONObject().put("amount", 42)
                ...
                .put("product", restTemplate.getRestTemplate().getUriTemplateHandler().expand(API_REST_BASE_PATH) + "/products/" + chicken.getId());
        HttpEntity<String> orderEntryHttpEntity = new HttpEntity<>(orderEntryReqJson.toString(), commonHeaders);

        ResponseEntity<String> addOrderEntryWithProductToOrderRes = restTemplate.postForEntity(API_REST_BASE_PATH +
    ...
    private ResponseEntity<Session> createNewSession() {
        ...
        return restTemplate.postForEntity(API_REST_BASE_PATH + "/sessions", httpEntity, Session.class);
    }
    ...
    private ResponseEntity<String> createNewOrder(String sessionLink, String status) {
        ...
        return restTemplate.postForEntity(API_REST_BASE_PATH + "/orders", httpEntity, String.class);
    }
}
